...
<div>
	...
	<div class="pure-u-2-3" align="center">
		...
		<form action="?act=pendaftaran" method="post" class="pure-form">
			...
			<input type="text" name="pendaftaran_search_key" class="pure-input-rounded" placeholder="Nama" value="<%=searchKey%>" />
		...
		<table class="pure-table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a class="button-secondary pure-button" href="?act=view_pendaftaran&nama=<%=pagePendaftaran.getResultList().get(i).getString("nama")%>">View</a>
						|
						<a class="button-warning pure-button" href="?act=edit_pendaftaran&nama=<%=pagePendaftaran.getResultList().get(i).getString("nama")%>">Edit</a>
						|
						<a class="button-error pure-button" href="?act=delete_pendaftaran&nama=<%=pagePendaftaran.getResultList().get(i).getString("nama")%>">Delete</a>
					</td>
				</tr>
				<% } %>
			</tbody>
		...
		<div>
			<a href="?act=tambah_pendaftaran"class="button-success pure-button" >Tambah Pasien</a> 
		</div>
	</div>
